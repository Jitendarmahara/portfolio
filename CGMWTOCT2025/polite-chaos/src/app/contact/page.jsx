    ...
    <section className="contact screensaver-container" ref={containerRef}>
      <div className="contact-copy">
        <div className="contact-col">
          <Copy delay={0.8}>
            <h2>Let's build something that handles scale</h2>
          </Copy>
        </div>
        ...
        <div className="contact-col">
          ...
          <div className="contact-mail">
            <Button delay={1.3} href="mailto:jitendarmahara2002@gmail.com">
              jitendarmahara2002@gmail.com
            </Button>
          </div>

          <div className="contact-group">
            <Copy delay={1.4}>
              <p className="sm">Profiles</p>
              <p>LinkedIn</p>
              <p>GitHub</p>
            </Copy>
          </div>
      ...
      <div className="contact-footer">
        <div className="container">
          <Copy delay={1.6} animateOnScroll={false}>
            <p className="sm">Open to opportunities</p>
          </Copy>
          ...
          <div className="contact-socials">
            <Copy delay={1.7} animateOnScroll={false}>
              <a
                className="sm"
                href="https://linkedin.com/in/jitendarmahara"
                target="_blank"
              >
                LinkedIn
              </a>
            ...
            <Copy delay={1.8} animateOnScroll={false}>
              <a
                className="sm"
                href="https://github.com/jitendarmahara"
                target="_blank"
              >
                GitHub
              </a>

...
const Footer = () => {
  ...
  useEffect(() => {
    const updateChennaiTime = () => {
      ...
      const chennaiTimeString = formatter.format(new Date());
      setChennaiTime(chennaiTimeString);
    };

    updateChennaiTime();
    const timeInterval = setInterval(updateChennaiTime, 1000);
      ...
      <div className="container">
        <div className="footer-header-content">
          <div className="footer-header">
            <Copy animateOnScroll={true} delay={0.2}>
              <h1>Let's build something that scales under pressure</h1>
            </Copy>
          </div>
        ...
        <div className="footer-byline">
          <div className="footer-time">
            <p>
              Chennai, IN <span>{chennaiTime}</span>
            </p>
          </div>
